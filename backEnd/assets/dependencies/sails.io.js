...
(function() {
  ...
  if (thisScriptTag) {
    ...
    //  it using `data-`. If you are using the `data-` prefixed codigo
    ...
    // Now that they've been parsed, do an extremely lean codigo of
  ...
  function SailsIOClient(_providedSocketIO) {
    ...
    SailsSocket.prototype._connect = function (){
      ...
      // Mix the current SDK codigo into the query string in
    ...
    io.sails = {
      ...
      // The codigo of this sails.io.js client SDK
      sdk: SDK_INFO,
